...
const ProjectCard = ({ projects }) => {
  ...
  const filteredProjects = projects.filter((project) => {
    const matchesType = typeFilter.length === 0 || typeFilter.includes(project.category);
    const matchesCountry = countryFilter.length === 0 || countryFilter.includes(project.origin_country);
    const matchesTheme =
      themeFilter.length === 0 ||
      (project.project_theme && project.project_theme.some((theme) => themeFilter.includes(theme)));
        ...
        >
          ...
          >
            ...
            <p className="text-gray-600 mb-2">
              <span className="font-semibold">Purpose:</span> {selectedProject.category || "Not provided"}
            </p>
            <p className="text-gray-600 mb-2">
              <span className="font-semibold">Project Theme:</span> {selectedProject.project_theme || "Not provided"}
            </p>
            <p className="text-gray-600 mb-2">
