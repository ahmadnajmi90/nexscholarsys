...
const UndergraduateList = ({ undergraduates, faculties, researchOptions, universities, faculty, university, users, skills, searchQuery }) => {
  ...
  const handleSearch = useCallback((searchTerm) => {
    router.get(route('faculties.undergraduates', { faculty: faculty.id }), 
      { search: searchTerm }, 
    ...
    <MainLayout title="">
      ...
      <div className="p-4 md:p-8">
        ...
        <StudentProfileCard 
            ...
            faculties={faculties}
            isPostgraduateList={false}  // Set to false for undergraduates
