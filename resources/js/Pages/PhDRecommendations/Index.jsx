...
export default function Index({ existingCv = null, searchHistory = [] }) {
    ...
    const handleSubmit = (e) => {
        ...
        post(route('phd-recommendations.analyze'));
    };
    ...
    return (
        <MainLayout title="Find Your Perfect PhD Match">
            <div className="max-w-4xl mx-auto p-6">
                <Head title="Find Your Perfect PhD Match" />
                <h1 className="text-3xl font-bold mb-2 text-center text-gray-900">Find Your Perfect PhD Match</h1>
                <p className="text-gray-600 text-center mb-8">Upload your CV and your research interests to get AI-powered PhD program recommendations.</p>
