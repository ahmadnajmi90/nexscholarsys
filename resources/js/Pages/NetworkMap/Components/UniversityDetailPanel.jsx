...
export default function UniversityDetailPanel({ university, onClose }) {
            ...
            >
                ...
                <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-blue-600 to-blue-700 text-white">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-xl font-bold">{university.shortName}</h2>
                ...
                <ScrollArea className="h-[calc(100vh-73px)]">
                    <div className="p-6 space-y-6">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-2xl font-bold text-blue-700 dark:text-blue-300">
                                            {university.publications?.toLocaleString() || 'N/A'}
                                        </p>
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-2xl font-bold text-orange-700 dark:text-orange-300">
                                            {university.industryCitations?.toLocaleString() || 'N/A'}
                                        </p>
                        ...
                        <Button
                            ...
                            onClick={() => alert('View Full Details functionality coming soon!')}
                        >
                            View Full Profile
                        </Button>
                    </div>
