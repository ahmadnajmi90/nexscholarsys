...
export default function ResearchFieldsTab() {
    ...
    const fetchFields = async () => {
        ...
        try {
            const response = await axios.get('/api/v1/fields-of-research', {
                params: {
                    per_page: 100,
    ...
    const fetchAreas = async () => {
        ...
        try {
            const response = await axios.get('/api/v1/research-areas', {
                params: {
    ...
    const fetchDomains = async () => {
        ...
        try {
            const response = await axios.get('/api/v1/niche-domains', {
                params: {
    ...
    const handleDeleteField = () => {
        ...
        const deleteAction = async () => {
            try {
                ...
                await axios.delete(`/api/v1/fields-of-research/${currentField.id}`);
    ...
    const handleDeleteArea = () => {
        ...
        const deleteAction = async () => {
            try {
                // Step 1: Make the API call with axios
                await axios.delete(`/api/v1/research-areas/${currentArea.id}`);
    ...
    const handleDeleteDomain = () => {
        ...
        const deleteAction = async () => {
            try {
                // Step 1: Make the API call with axios
                await axios.delete(`/api/v1/niche-domains/${currentDomain.id}`);
