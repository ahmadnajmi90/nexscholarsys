...
export default function UniversitiesTab() {
    ...
    const handleSearch = (e) => {
        ...
        // The fetchUniversities effect will trigger
    };
    ...
    return (
        <div>
            ...
            <ConfirmationModal
                ...
                message={`Are you sure you want to delete ${currentUniversity?.full_name}? This action cannot be undone.`}
