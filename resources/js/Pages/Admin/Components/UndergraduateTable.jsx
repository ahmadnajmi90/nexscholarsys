...
const UndergraduateTable = ({ undergraduates, universities, faculties, onSendReminder, pagination }) => {
                    ...
                    <div>
                        <nav className="inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
                            {pagination.current_page > 1 && (
                                <a
                                    href={`?undergraduates_page=${pagination.current_page - 1}`}
    ...
    return (
        <div className="mt-6">
            <h2 className="text-xl font-semibold mb-3">Undergraduates</h2>
                ...
                <table className="min-w-full divide-y divide-gray-200">
                    <thead className="bg-gray-50">
                        <tr>
                            ...
                            <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Research Interest</th>
                        ...
                        {undergraduates && undergraduates.length > 0 ? (
                            undergraduates.map((user) => {
                                ...
                                <tr key={user.id}>
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        {profile?.degree_program || 'Not specified'}
                                    </td>
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        {profile?.research_preference 
                                            ? (typeof profile.research_preference === 'string' 
                                                ...
                                                : Array.isArray(profile.research_preference) 
                                                    ? profile.research_preference.join(', ')
                            ...
                            <tr>
                                <td colSpan="9" className="px-6 py-4 text-center text-sm text-gray-500">No undergraduates found</td>
                            </tr>
                        )}
                    </tbody>
                </table>
