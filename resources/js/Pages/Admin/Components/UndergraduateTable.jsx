...
const UndergraduateTable = ({
    ...
    const handleBatchDeactivate = async () => {
        ...
        try {
            ...
            setTimeout(() => {
                router.reload({ only: ['undergraduates'] });
                setSelectedUsers([]);
                setBatchSent(false);
            }, 2000);
        } catch (error) {
                    ...
                    <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-6">
                        ...
                        <div className="mb-6">
                            <p className="text-sm text-gray-600 mb-3">
                                You are about to deactivate <span className="font-bold text-red-600">{selectedUsers.length}</span> undergraduate account{selectedUsers.length !== 1 ? 's' : ''}.
                            </p>
