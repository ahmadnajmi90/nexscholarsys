...
/**
 * SupervisorOverviewTab - Shows STUDENT information (for supervisor's view)
 * Used in: SupervisorRelationshipDetailModal, RelationshipFullPage (supervisor view)
 */
export default function SupervisorOverviewTab({ relationship, student, activeUnbindRequest }) {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <section className="border border-slate-200 rounded-lg p-6 bg-white shadow-sm">
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <InfoItem icon={Mail} label="Email" value={student.email || student.user?.email || '—'} />
          ...
          {student.university_details && (
            <div className="pt-4 border-t">
              <div className="grid grid-cols-2 gap-4">
                <InfoItem icon={GraduationCap} label="University" value={student.university_details.full_name || '—'} />
                {student.faculty && (
      ...
      <section className="border border-slate-200 rounded-lg p-6 bg-white shadow-sm">
        <h3 className="text-lg font-semibold text-slate-900 mb-4">Supervision Summary</h3>
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <InfoItem label="ScholarLab" value={relationship.scholarlab_board_id ? 'Active' : 'Not provisioned'} />
          </div>
        </div>
      </section>
