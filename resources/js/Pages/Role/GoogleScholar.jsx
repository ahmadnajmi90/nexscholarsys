    ...
    return (
        ...
        >
            ...
            <div className="py-0 md:py-2 lg:py-2">
                <div className="max-w-8xl mx-auto sm:px-6 md:px-0 lg:px-0 space-y-6 border border-gray-200 rounded">
                    {flash.message && (
                    ...
                    <div className="px-6">     
                        ...
                        {!academician.google_scholar && (
                            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-4 shadow-md rounded-md mx-4">
