  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      ...
      <div className="flex items-center justify-center min-h-screen p-4">
        <div 
          className="relative bg-white rounded-lg shadow-lg p-6 w-11/12 max-w-lg max-h-[90vh] overflow-y-auto z-10"
          onClick={(e) => e.stopPropagation()}
        >
          {/* All the existing modal content (header, form, etc.) goes here */}
          ...
          <form onSubmit={handleSubmit}>
            {/* ... all the existing form fields (Communication, Supportiveness, etc.) ... */}
            <div className="mb-6">
