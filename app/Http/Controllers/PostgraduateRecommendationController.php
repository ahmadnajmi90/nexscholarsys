...
use App\Jobs\GeneratePostgraduateRecommendations;
...
class PostgraduateRecommendationController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('PostgraduateRecommendations/Index', [
            'existingCv' => $cvData,
    ...
    public function analyze(Request $request)
    {
        $validated = $request->validate([
            ...
            'program_type' => 'required|in:Any,Master,PhD',
        ]);
    ...
    public function results()
    {
        ...
        if ($latestBatchId) {
            $recommendations = \App\Models\ProgramRecommendationResult::where('batch_id', $latestBatchId)
                ->with([
                    'postgraduateProgram' => function ($query) {
                        $query->withCount('academicians as supervisors_count');
                    },
                    'postgraduateProgram.university',
    ...
    public function showSupervisors(PostgraduateProgram $program)
    {
        $user = Auth::user();
