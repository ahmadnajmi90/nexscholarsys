...
class PhDProgram extends Model
{
    use HasFactory;

    protected $table = 'phd_programs';
    ...
    public function academicians(): BelongsToMany
    {
        ...
        return $this->belongsToMany(Academician::class, 'academician_phd_program', 'phd_program_id', 'academician_id')
            ->withTimestamps();
    }
}
